...
namespace InForm.Server.Migrations
{
    ...
    [Migration("20240217214329_MultiChoice_Init")]
    partial class MultiChoice_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InForm.Server.Features.FillForms.Db.MultiChoiceFillSelection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FillDataId");

                    b.HasIndex("OptionId");

                    b.ToTable("MultiChoiceFillSelections", "InForm");
                });
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.MultiChoiceOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MultiChoiceOptions", "InForm");
                });

            modelBuilder.Entity("InForm.Server.Features.FillForms.Db.MultiChoiceFillData", b =>
                {
                    ...
                    b.ToTable("MultiChoiceFillDatas", "InForm");
                });
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.MultiChoiceFormElement", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("MultiChoiceFormElement");
                });
            ...
            modelBuilder.Entity("InForm.Server.Features.FillForms.Db.MultiChoiceFillSelection", b =>
                {
                    b.HasOne("InForm.Server.Features.FillForms.Db.MultiChoiceFillData", "FillData")
                        .WithMany("Selected")
                        .HasForeignKey("FillDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InForm.Server.Features.Forms.Db.MultiChoiceOption", "Option")
                        .WithMany()
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.MultiChoiceOption", b =>
                {
                    b.HasOne("InForm.Server.Features.Forms.Db.MultiChoiceFormElement", "Element")
                        .WithMany("Options")

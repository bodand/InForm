...
namespace InForm.Server.Migrations
{
    ...
    [Migration("20240213231359_NumericRange_Init")]
    partial class NumericRange_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.RangeElementQuestion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RangeElementQuestion", "InForm");
                });

            modelBuilder.Entity("InForm.Server.Features.FillForms.Db.NumericRangeFillData", b =>
                {
                    ...
                    b.Property<long>("ParnetElementId")
                        .HasColumnType("bigint");

                    b.Property<long>("RangeElementQuestionId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RangeElementQuestionId");

                    b.ToTable("NumericRangeFillData", "InForm");
                });
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.NumericRangeElement", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("NumericRangeElement");
                });
            ...
            modelBuilder.Entity("InForm.Server.Features.Forms.Db.RangeElementQuestion", b =>
                {
                    b.HasOne("InForm.Server.Features.Forms.Db.NumericRangeElement", "Parent")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("InForm.Server.Features.FillForms.Db.NumericRangeFillData", b =>
                {
                    b.HasOne("InForm.Server.Features.Forms.Db.NumericRangeElement", "ParentElement")
                        .WithMany("FillData")
                        .HasForeignKey("ParentElementId");

                    b.HasOne("InForm.Server.Features.Forms.Db.RangeElementQuestion", "RangeElementQuestion")
                        .WithMany()
                        .HasForeignKey("RangeElementQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ParentElement");

                    b.Navigation("RangeElementQuestion");
                });
